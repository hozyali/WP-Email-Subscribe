...
<input type="hidden" id="theme_count" value="3" />
<input type="hidden" id="frm_id" value="<?php echo $frm['frm_id']; ?>" />
<input type="hidden" id="ajax_url" value="<?php echo admin_url('admin-ajax.php'); ?>" />
<input type="hidden" id="background_url" value="<?php echo wpulist_form_image($frm['frm_id'], plugins_url('images/bg.png', __FILE__)); ?>" />
<div class="thme3">
    <div class="left">
