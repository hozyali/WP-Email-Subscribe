...
<input type="hidden" id="theme_count" value="14" />
<input type="hidden" id="frm_id" value="<?php echo $frm['frm_id']; ?>" />
<input type="hidden" id="ajax_url" value="<?php echo admin_url('admin-ajax.php'); ?>" />
<input type="hidden" id="background_url" value="" />
<div class="thme14">
    ...
    <form method="post" id="wpulist_frm_<?php echo $frm['frm_id'] ?>" name="wpulist_frm_<?php echo $frm['frm_id'] ?>">
        <?php echo wpulist_generate_frm_fields($frm['frm_id'], $wpulist_frm_items, 0, $css_name, 'emlfield'); ?>
