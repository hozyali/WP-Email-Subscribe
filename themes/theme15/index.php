...
<input type="hidden" id="theme_count" value="15" />
<input type="hidden" id="frm_id" value="<?php echo $frm['frm_id']; ?>" />
<input type="hidden" id="ajax_url" value="<?php echo admin_url('admin-ajax.php'); ?>" />
<input type="hidden" id="background_url" value="<?php echo wpulist_form_image($frm['frm_id'], plugins_url('images/themebg15.jpg', __FILE__)); ?>" />
<div class="thme15">
    <h1 class="title"><?php echo $frm_info->post_title; ?></h1>
    <div class="bdtext">
        <p style=" text-align:center"><?php echo apply_filters('the_content', $frm_info->post_content); ?></p>
    </div>
    <div class="clear"></div>
    <form method="post" id="wpulist_frm_<?php echo $frm['frm_id'] ?>" name="wpulist_frm_<?php echo $frm['frm_id'] ?>">
        <?php echo wpulist_generate_frm_fields($frm['frm_id'], $wpulist_frm_items, 1, 'emlfield', 'emlfield'); ?>
